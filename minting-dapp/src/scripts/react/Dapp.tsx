        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              Heckin Chonkers is an NFT collection of 6666 CC0 fat cats who were so bad, they died and went to heck. Did your chonk appease the gods? Only a mint will tell. Connect your wallet to go to heck and save your kitty. <br />
              <br />
              Advanced user looking for a <strong>super-safe experience</strong>? <br />
              You can interact with the smart-contract and mint your NFT <strong>directly</strong> through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a>, without even connecting your wallet to this DAPP! <br />
              <br />
            </div>
            ...
            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
                ...
                <p>
                  Enter your Polygon / Ethereum address to see if you are on the whitelist!
                </p>
